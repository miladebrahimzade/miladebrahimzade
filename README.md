...
# 👋 Hey there, I'm Milad Ebrahimzadeh

### Full-Stack Developer | React · Next.js · Django · TypeScript

_Building modern, scalable web applications with clean architecture and user-focused design_

<!-- [![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/miladebrahimzade) -->
...
💼 **Full-Stack Developer** building the web since 2021  
🎯 **Current Focus:** Advanced Backend Architecture · Clean Code Principles · Scalable System Design  
📚 **Learning Journey:** Deepening expertise in backend development and architectural patterns

I'm passionate about creating **fast**, **reliable**, and **elegant** web experiences. Always learning, always improving. 🚀
...
Role-based customer portal automating service workflows and secure document handling
...
Interactive dashboard with ECharts and real-time data visualization, auto PDF export

`Next.js` `Django` `Apache ECharts`
...
Internal platform improving usability and admin workflows
...
Modern, responsive storefront built during an internship
